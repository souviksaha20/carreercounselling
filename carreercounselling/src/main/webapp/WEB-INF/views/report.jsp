	...
	<div class="col-sm-12 col-lg-12">
		<div class="card card-chart">
					<div class="card-header card-header-success">
					  <center><h1>Dear Student/Parent/Teacher</h1></center>	
					</div>
		<div class="card-body">
		<p>
		This Career assessment report was developed to help people clarify their interests and relate them to work and career options. When a person can link what they like to do, with jobs that fulfill those interests, they can make better career decisions.
		</p>
		<p>The career report can help people make the connection between what they like to do and careers that meet these desires. By guiding people to make better career choices, people can pursue careers that are more likely to be enjoyable and satisfying. Research shows that people working in careers that match their interests are happier and more satisfied than people who are not. </p>
...
<!-- 		<script src="svg-donut-chart-framework.js"></script> -->
		...
		//alert("These are your best dimensions and their scores "+obj);
			var _gaq = _gaq || [];
